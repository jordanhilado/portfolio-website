...
export function ThoughtPostClient({
  post,
  readingTime,
  formattedDate,
    ...
    <div className="flex flex-col gap-y-4">
      ...
      <article className="w-full text-base/5 text-neutral-500 dark:text-neutral-400">
        <header className="mb-6">
          <h1
            className="text-xl sm:text-2xl font-semibold mb-2 text-sky-600 dark:text-sky-400 font-songmyung"
          >
            {post.title}
          </h1>
